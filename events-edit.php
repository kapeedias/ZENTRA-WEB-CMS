                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="small text-muted mb-1"><span>Event
                                                                Timezone</span><span class="text-danger">*</span></div>
                                                        <div class="fw-semibold">
                                                            <select class="form-select-sm form-select text-warning"
                                                                name="event_timezone" id="event_timezone"
                                                                required="yes">
                                                                <?php
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="small text-muted mb-1"><span>Event
                                                                Location</span><span class="text-danger">*</span></div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="small text-muted mb-1"><span>Event
                                                                Category</span><span class="text-danger">*</span></div>
                                                        <div class="fw-semibold"><select
                                                                class="form-select-sm form-select text-warning"
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                ...
                                                <button class="btn btn-warning text-white btn-sm" type="button"
                                                    data-bs-toggle="modal" data-bs-target="#tagPickerModal"> Add Event
                                                    Tags
                                                </button>
                                            </div>
                                        ...
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body pt-2"><img class="img-fluid rounded w-100 h-100"
                                                ...
                                                <div class="d-flex gap-2"><a class="btn btn-outline-primary btn-sm"
                                                        ...
                                                        role="button" href="#"><i class="fa fa-facebook-square"></i></a>
                                                </div>
                                            </div>
                                        </div><!-- End: event-poster -->
